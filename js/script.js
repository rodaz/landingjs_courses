...
var actSkills = actMember.data('skills');
    ...
    function timersGO() {
       var timer1 = setInterval(function() {
        if(cnt1 == +actSkills[0].level) clearInterval(timer1);
        progressBarUpdate(cnt1, 100, pie1);
        cnt1+=1;
      }, 25);

      var timer2 = setInterval(function() {
        if(cnt2 == +actSkills[1].level) clearInterval(timer2);
        progressBarUpdate(cnt2, 100, pie2);
        cnt2+=1;
      }, 24);

      var timer3 = setInterval(function() {
        if(cnt3 == +actSkills[2].level) clearInterval(timer3);
        progressBarUpdate(cnt3, 100, pie3);
        cnt3+=1;
      },26);

      var timer4 = setInterval(function() {
        if(cnt4 == +actSkills[3].level) clearInterval(timer4);
  ...
  $('.top-line a[href^="#"]').on('click', function() {
...
////////////////////////////////////////////////
    ...
    aboutImg.hover(
        function(){
          $(this).stop().animate({width: (elem2Width+elem2Width/10)+'px', height: (elem2Height+elem2Height/10)+'px'}, 400);

      }, function() {
          $(this).stop().animate({width: elem2Width+'px', height: elem2Height+'px'}, 400);
      });
///////////portfolio////////////
...
/////////////////counters//////////////////////
    ...
    doc.scroll(function(e) {
        if(pos-$(window).innerHeight()/1.4 < doc.scrollTop() && doc.scrollTop() < pos+$(window).innerHeight()/5) {
            prideCounters();
            doc.unbind(e);
        }
    });
...
///////////////////review-slider////////////////////////////////////////
    var reviews = [
        ...
        {quote: '“There are many variations of passages of Lorem Ipsum available, but'+
            'the majority have suffered alteration in some form, by injected humour, or'+
            'randomised words which dont look even slightly believable.”',
        autor: 'Mark Terry'},
        {quote: '“Contrary to popular belief, Lorem Ipsum is not simply random text. It'+
